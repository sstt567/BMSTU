...
(2, 'Создать несколько документов', 'Средний', '2024-02-20', 'Отложена'),  -- Исправлена опечатка и дата
(3, 'Протестировать авторизацию', 'Низкий', '2024-01-10', 'Выполнена');    -- Исправлена опечатка и дата
--4.3--
